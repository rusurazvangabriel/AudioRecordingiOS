...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.layer.shadowColor = [[UIColor whiteColor] CGColor];//[UIColor colorWithRed:0/255.0f green:67/255.0f blue:253/255.0f alpha:1.0f] CGColor];
        self.layer.shadowOffset = CGSizeMake(13.0f, 13.0f);
        ...
        NSArray *colors = [NSArray arrayWithObjects:
                           ...
                           (id)[UIColor colorWithRed:61/255.0f green:200/255.0f blue:211/255.0f alpha:1.0f],
                           (id)[UIColor colorWithRed:61/255.0f green:107/255.0f blue:226/255.0f alpha:1.0f].CGColor,
                           nil];
