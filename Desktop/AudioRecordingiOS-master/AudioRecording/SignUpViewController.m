...
- (void)viewDidLoad
{
    ...
    _usernameTextField = [[RRTextField alloc] initWithCoordinates:X_Co y:150];
    _usernameTextField.placeholder = @"Username";
    _usernameTextField.returnKeyType = UIReturnKeyNext;
    _usernameTextField.delegate = self;
    [self.view addSubview:_usernameTextField];
    
    _emailTextField = [[RRTextField alloc] initWithCoordinates:X_Co y:200];
    _emailTextField.placeholder = @"Email";
    _emailTextField.returnKeyType = UIReturnKeyNext;
    _emailTextField.delegate = self;
    [self.view addSubview:_emailTextField];
    
    _passwordTextField = [[RRTextField alloc] initWithCoordinates:X_Co y:250];
    ...
    _passwordAgainTextField = [[RRTextField alloc] initWithCoordinates:X_Co y:300];
    ...
    _signUpButton = [[RRButton alloc] initWithFrame:CGRectMake(X_Co, 380, 240, 35)];
