...
{
    //Load the image
    UIImage *buttonImage = [UIImage imageNamed:@"playback_play.png"];
    //create the button and assign the image
    UIButton *button = [UIButton buttonWithType:UIButtonTypeCustom];
    [button setImage:buttonImage forState:UIControlStateNormal];
    [button addTarget:self action:@selector(functionTest) forControlEvents:UIControlEventTouchUpInside];
    //sets the frame of the button to the size of the image
    button.frame = CGRectMake(0, 0, 26, 26);
    //creates a UIBarButtonItem with the button as a custom view
    UIBarButtonItem *playToolbarButton = [[UIBarButtonItem alloc] initWithCustomView:button];
    
    //Load the image
    UIImage *buttonImage1 = [UIImage imageNamed:@"playback_stop_icon.png"];
    //create the button and assign the image
    ...
    //sets the frame of the button to the size of the image
    button1.frame = CGRectMake(0, 0, 26, 26);
    //creates a UIBarButtonItem with the button as a custom view
    UIBarButtonItem *stopToolbarButton = [[UIBarButtonItem alloc] initWithCustomView:button1];
    
    UIBarButtonItem *backToolbarButton = [self createBarButtonWithTitle:@"Menu" andDelegate:@selector(goToMainView)];
    
    //Load the image
    UIImage *buttonImage4 = [UIImage imageNamed:@"magnet.png"];
    //create the button and assign the image
    UIButton *button4 = [UIButton buttonWithType:UIButtonTypeCustom];
    [button4 setImage:buttonImage4 forState:UIControlStateNormal];
    [button4 addTarget:self action:@selector(setSnap) forControlEvents:UIControlEventTouchUpInside];
    //sets the frame of the button to the size of the image
    button4.frame = CGRectMake(0, 0, 21, 21);
    //creates a UIBarButtonItem with the button as a custom view
    UIBarButtonItem *snapToolbarButton = [[UIBarButtonItem alloc] initWithCustomView:button4];
    
    //Load the image
    UIImage *buttonImage2 = [UIImage imageNamed:@"save.png"];
    //create the button and assign the image
    UIButton *button2 = [UIButton buttonWithType:UIButtonTypeCustom];
    [button2 setImage:buttonImage2 forState:UIControlStateNormal];
    [button2 addTarget:self action:@selector(saveProject) forControlEvents:UIControlEventTouchUpInside];
    //sets the frame of the button to the size of the image
    button2.frame = CGRectMake(0, 0, 18, 18);
    //creates a UIBarButtonItem with the button as a custom view
    UIBarButtonItem *saveToolbarButton = [[UIBarButtonItem alloc] initWithCustomView:button2];
    
    //Load the image
    UIImage *buttonImage3 = [UIImage imageNamed:@"add_sample.png"];
    //create the button and assign the image
    UIButton *button3 = [UIButton buttonWithType:UIButtonTypeCustom];
    [button3 setImage:buttonImage3 forState:UIControlStateNormal];
    [button3 addTarget:self action:@selector(addSampleToProject) forControlEvents:UIControlEventTouchUpInside];
    //sets the frame of the button to the size of the image
    button3.frame = CGRectMake(0, 0, 20, 20);
    //creates a UIBarButtonItem with the button as a custom view
    UIBarButtonItem *addToolbarButton = [[UIBarButtonItem alloc] initWithCustomView:button3];
    UIBarButtonItem *addChannelButton = [self createBarButtonWithTitle:@"+C" andDelegate:@selector(addChannel)];
    
    //Load the image
    UIImage *buttonImage5 = [UIImage imageNamed:@"load_icon.png"];
    //create the button and assign the image
    UIButton *button5 = [UIButton buttonWithType:UIButtonTypeCustom];
    [button5 setImage:buttonImage5 forState:UIControlStateNormal];
    [button5 addTarget:self action:@selector(loadProjectFromNSData) forControlEvents:UIControlEventTouchUpInside];
    //sets the frame of the button to the size of the image
    button5.frame = CGRectMake(0, 0, 21, 21);
    //creates a UIBarButtonItem with the button as a custom view
    UIBarButtonItem *loadToolbarButton = [[UIBarButtonItem alloc] initWithCustomView:button5];
    
    [self.toolbar setItems:@[playToolbarButton,stopToolbarButton,saveToolbarButton,loadToolbarButton,addChannelButton,addToolbarButton,snapToolbarButton,backToolbarButton] animated:NO];
}
...
-(void) loadProjectFromNSData
{
    ...
    for (NSDictionary* sample in project[@"sampleList"]){
        if(max < [[sample valueForKey:@"channel"] integerValue])
        {
            max = [[sample valueForKey:@"channel"] integerValue];
        }
...
-(void) dragEnded:(id) sender
{
    ...
    [self.view bringSubviewToFront:currentSample];
    int separator = 40;
...
-(int) getClosestSampleHorizontalCoordonate:(RRSample*) currentSample
{
    ...
    if (buttonToSnapTo != NULL) {
        return buttonToSnapTo.frame.origin.x + buttonToSnapTo.frame.size.width + 0.5;
    }
    else
    {
        for(RRSample *sample in _eventList)
